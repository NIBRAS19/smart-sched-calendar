...
import { Calendar, CheckCircle, Users, Brain, Clock, Zap } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Intelligent Calendar Management</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Experience the future of scheduling with our AI-powered features designed to make your life easier
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">AI-Powered Scheduling</h3>
                  <p className="text-muted-foreground">
                    Our advanced AI learns your scheduling patterns and suggests optimal meeting times, 
                    automatically resolving conflicts and finding the perfect slots for your events.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Smart Time Management</h3>
                  <p className="text-muted-foreground">
                    Intelligent scheduling that considers time zones, working hours, and personal preferences 
                    to create the most efficient schedule for you and your team.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    One-click scheduling, instant meeting creation, and smart templates that adapt to your needs.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to experience smart scheduling?</h2>
